...
public class VoskSpeechToText : MonoBehaviour
{
    ...
    {
        // Устанавливаем флаг записи в true
        _isRecording = true;
        // Запускаем процесс записи голоса
        VoiceProcessor.StartRecording();
        // Запускаем асинхронную задачу обработки записи
        Task.Run(ThreadedWork).ConfigureAwait(false);
    }

    // Метод для остановки записи голоса
    public void StopRecording()
    {
        // Устанавливаем флаг записи в false
        _isRecording = false;
    ...
    {
        // Продолжаем работу только если запись активна
        while (_isRecording)
        {
            ...
            // Пока идет запись голоса, обрабатываем аудиоданные
            while (_isRecording)
            {
